...
<tr class="multiple_choice">
	...
	<td>
		<div class="mquiz-form-group mquiz-form-answer">
			<textarea name="answers[<?php echo $i;?>]" id="answer_<?php echo $i;?>" class="form-controls" rows="3"><?php echo $answer;?></textarea></div>
	</td>
	<td class="w150 valign-top">
		<div class="mquiz-form-group mquiz-form-answer  mquiz-form-answer-correct">
			<div class="checkbox">
				<label>
					<input <?php echo (TRUE === $correct) ? "checked='checked'" : ""; ?> type="radio" value="<?php echo $i;?>"  id="answer_correct_<?php echo $i;?>" name="correct"> <?php _e('Accept as correct', 'huuminh');?>
				</label>
			</div>
